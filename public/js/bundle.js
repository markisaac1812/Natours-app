      ...
      while (1) switch (_context.p = _context.n) {
        ...
        case 2:
          ...
          if (_t.response && _t.response.data) {
            (0, _alerts.showAlert)('error', _t.response.data.message || 'An error occurred during signup');
          } else {
...
var getStripe = function getStripe() {
  if (window.Stripe) {
    return window.Stripe('pk_test_51S5mQHJXU6WmT8UTTxOyo2uiP8F674ZnkzW7Y1WL429o2GvsFJHRXmlAIGURBknsBCdcoiYeziZDDXF8P5YvG5mu00df65CFgn');
  }
  return null;
};
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 2:
          ...
          break;
        case 3:
          (0, _alerts.showAlert)('error', 'Stripe is not loaded. Please refresh the page.');
        case 4:
          _context.n = 6;
          break;
        case 5:
